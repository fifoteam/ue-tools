...
function UCFcomp_lpc(){
	...
	for(CurrentLine=0;CurrentLine<=TotalLine;CurrentLine++){
		...
		str=TrimCommentSharp(str);
		//  -------------------------------------------------------------------------------------
		//	将LOC作为关键字
		//  -------------------------------------------------------------------------------------
		if(str.indexOf("LOC")!=-1){
			NewNetLoc[i]	= UCFGetLocValue(str);
			NewNetName[i]	= UCFGetNetName(str);
			i++;
		}
	}
...
//	}
	...
	for(CurrentLine=0;CurrentLine<=TotalLine;CurrentLine++){
		...
		//  -------------------------------------------------------------------------------------
		if(str.indexOf("LOC")!=-1){
			OldNetLoc[i]	= UCFGetLocValue(str);
			OldNetName[i]	= UCFGetNetName(str);
			i++;
		}
	}
