...
function UCFcomp(){
	...
	file1 = UltraEdit.getString("Specify first file",1);
	file2 = UltraEdit.getString("Specify Second file",1);



	UltraEdit.open(""+file1+"");
...
//	}
	...
	UltraEdit.activeDocument.write("new ucf file is "+file1+"\r\n");
	UltraEdit.activeDocument.write("old ucf file is "+file2+"\r\n\r\n");
